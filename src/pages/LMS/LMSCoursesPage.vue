  ...
  <div class="q-pa-lg">
    ...
    <div class="row justify-between items-center q-mb-xl">
      <div>
        ...
        <h1 class="text-display q-my-none">My Courses</h1>
        <p class="text-body q-my-none" style="color: var(--text-secondary);">Select a course to view its modules and learning materials.</p>
      </div>
    </div>
    ...
    <div v-else class="row q-col-gutter-lg">
      <div v-if="!normalizedCourses.length" class="col-12 text-center text-muted q-py-xl glass-card">
        You are not enrolled in or assigned to any courses.
      </div>
