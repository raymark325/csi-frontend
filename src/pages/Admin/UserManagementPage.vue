  ...
  <div class="q-pa-lg">
    ...
    <div class="row items-center justify-between q-mb-xl">
      <div>
        ...
        <p
          class="text-body q-mt-xs q-mb-none"
      ...
      <template v-slot:body-cell-photo="props">
        <q-td :props="props" class="text-center">
          <q-avatar
            ...
            v-if="props.row.profile?.profile_picture"
            @click="viewFullPhoto(props.row)"
          >
            <q-img
              :src="
                props.row.profile.profile_icon ||
                props.row.profile.profile_picture
              "
    ...
    <q-dialog v-model="showDialog" persistent>
      <q-card style="min-width: 500px; border-radius: 12px">
        <q-card-section class="row items-center q-pb-none">
          <div class="text-h6" style="font-weight: 700">
        ...
        <q-card-section>
          <q-form @submit="handleSave" class="q-gutter-md">
            ...
            <div
              v-if="isEditing && formData.profile_picture"
      ...
      <q-card style="min-width: 400px; max-width: 90vw">
        ...
        <q-card-section class="text-center">
          ...
          <div class="text-caption text-secondary">
            Role: {{ photoUser?.role.toUpperCase() }} | Status:
            {{ photoUser?.is_approved ? "APPROVED" : "PENDING" }}
          </div>
        </q-card-section>
        <q-card-actions
          align="center"
          class="q-pb-md"
          v-if="photoUser && !photoUser.is_approved"
        >
          <q-btn
            color="positive"
            icon="check_circle"
            label="Approve this User"
            @click="approveUserFromPhoto"
            unelevated
            rounded
          />
        </q-card-actions>
...
const columns = [
  ...
  },
  {
    name: "section",
    align: "left",
    label: "Section (if student)",
    field: (row) => row.profile?.section?.name || "-",
  },
  {
    name: "is_approved",
    align: "center",
